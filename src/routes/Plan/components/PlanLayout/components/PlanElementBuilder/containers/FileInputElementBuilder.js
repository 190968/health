...
import FileInputElementBuilderPure from '../components/FileInputElementBuilder';
...
export default (FileInputElementBuilderPure);


export const preparePlanElementFileInputInput = (values) => {
    const {title} = values;
