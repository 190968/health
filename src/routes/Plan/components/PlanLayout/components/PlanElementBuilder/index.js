...
export const withPlanElementUnion = conditionalWhenThen([
        ...
        { when: ({type}) => type === 'choice_input', then: OptionsElementBuilder },
        { when: ({type}) => type === 'radio_input', then: OptionsElementBuilder },
        { when: ({type}) => type === 'dropdown', then: OptionsElementBuilder },
