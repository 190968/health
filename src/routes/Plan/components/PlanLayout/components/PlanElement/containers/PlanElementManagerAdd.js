...
//  const AddLessonElementMutation = gql`
//     mutation addLessonElement1($planId: UID!, $type:PlanElementEnum!, $lessonId: UID!, $input:PlanBodyElementInput!) {
...
//     ${PlanElementPureFragment}
// `;
//  const withAddLessonMutation_todeletee = graphql(AddLessonElementMutation, {
//     props: ({ ownProps, mutate }) => ({
//         addLessonElement: (input) => {
//             return mutate({
//                 variables: {planId:ownProps.plan.id, type:ownProps.type, lessonId:ownProps.lessonId, input:input},
//                 refetchQueries: [{
...
//             return mutate({
//                 variables: {planId:ownProps.plan.id, type:ownProps.type, activityId:ownProps.sectionId, input:input},
//                 refetchQueries: [{
