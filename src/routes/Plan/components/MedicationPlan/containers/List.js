import MedicationsList from '../components/List';
import MedicationsTable from '../components/Table';
// import {MedicationCardInfo, MedicationsByType} from '../components/Medication/components/fragments';
import {compose, branch, renderComponent} from 'recompose';

const enhance = compose(
    branch(props => props.layout === 'table', renderComponent(MedicationsTable)),
);

export default enhance(MedicationsList);
