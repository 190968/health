...
export class PlanstorPlanLayout extends React.Component {
    ...
    render() {
        const { plan, loading, alreadyDownloaded, alreadyDownloadedUserPlan } = this.props;
        if (1 === 12 || loading) {
                        ...
                        <Col xs={24} md={14} offset={1} span={16} >
                            <div className="ap-card__body">
                                ...
                                <div className="ap-card__action">
                                    {alreadyDownloaded ? <Link to={'/plan/' + alreadyDownloadedUserPlan.id} ><Button icon="check" size="large" >Already Got It</Button></Link> :
