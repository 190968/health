...
// import { MessageComposeButton } from '../Buttons/components/Compose';
    ...
    return (<div className={'slider'}>
        <div className={'visitorList'}>
            ...
            <Row type="flex" className={'sliderHeader'}>
                <Col md={18}>Conversations <Tooltip title={'Leave Conversations'} placement={'bottomLeft'}><Link to={'/'}><Icon type="close-circle" /></Link></Tooltip></Col>
                <Col md={6} style={{textAlign: 'right'}}>
                <Tooltip title={'Update'}><Icon type="reload"  onClick={props.reload} /></Tooltip> <SendMessageButton iconOnly label={'Create Message'} goToMessage /></Col>
            </Row>
            <ThreadList {...props} />
        </div>
    </div>);
