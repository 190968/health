...
export const Vitals = props => {
    ...
    //console.log(props);
    return  <Card type="basic1 ant-card-type-pure" title="Vitals">
        <Carousel slidesToShow={slidesToShow} arrows={true} infinite={false} centerPadding={10} slidesToScroll={slidesToShow} responsive={[{ breakpoint: 900, settings: { slidesToShow: 2, slidesToScroll:2 }}, { breakpoint: 700, settings: { slidesToShow: 1, slidesToScroll:1 }}]}>
