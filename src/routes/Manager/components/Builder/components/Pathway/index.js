...
const PathwayBuilderLayout = props => {
    ...
    return <BuilderLayout logo={<center>Pathway Builder</center>} header={title} menu={menu} >
        <PlanbuilderContent {...props} routes={menuItems} mainUrl={mainUrl} type={'pathway'} />
    </BuilderLayout>
}

export default PathwayBuilderLayout;
