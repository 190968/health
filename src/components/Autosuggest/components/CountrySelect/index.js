...
const formatPhoneCodeLabel= item => {
    const { phoneCode } = item;
    return phoneCode;
}
...
const CountrySelect = (props) => {
    ...
    return <Select 
        ...
        getFullInfo={true}
        labelInValue={true} 
        i18n={{ placeholder: "Select Country" }} 
        items={items} 
        labelFormat={usePhoneCode ? formatPhoneCodeLabel : formatLabel}
        optionFilterProp={usePhoneCode ? 'phoneCode' : 'name'}
